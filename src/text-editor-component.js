...
class TextEditorComponent {
  ...
  //     this.refs.scrollContainer.scrollTop = this.autoscrollTop
  //     this.autoscrollTop = null
  //   }
  //
  //   if (autoscrollLeft != null) {
  //     this.refs.scrollContainer.scrollLeft = autoscrollLeft
  //   }
  //
  //   this.pendingAutoscroll = null
  // }
  ...
  getLastVisibleRow () {
    const heightInLines = this.getScrollContainerHeight() / this.getLineHeight()
    return Math.min(
      this.props.model.getApproximateScreenLineCount() - 1,
      this.getFirstVisibleRow() + heightInLines
    )
  }
  ...
  setScrollBottom (scrollBottom) {
    return this.setScrollLeft(scrollBottom - this.getScrollContainerClientWidth())
  }
